...
public class JdbcUserDao implements UserDao {
    ...
    public User update(User modifiedUser) {
        String sql = "UPDATE app_user SET username = ? WHERE user_id=?;";
        jdbcTemplate.update(sql, modifiedUser.getUsername(), modifiedUser.getUserId());
        return getUserById(modifiedUser.getUserId());
    }
