  ...
  methods: {
    formatTimestamp(timeStamp) {
      ...
      if (timeStamp == null) {
        ...
        return this.remainingTime(this.getTimeDifference(date));
      }
    },

    //the following method was generated by ChatGPT 3.5
    getTimeDifference(date) {
      const utcDate = timeServ.nowUTC(); // Get the current date/time
      const difference = date.getTime() - utcDate.getTime(); // Calculate the difference in milliseconds
